GhostX Core integration/staging tree
=====================================


https://www.ghostxbyjohnmcafee.com/
...
For more information, see https://www.ghostxbyjohnmcafee.com/


Getting Started
---------------

A new GhostX wallet will need an HD master key loaded and an initial account
...
GhostXd or GhostX-qt with the parameter: -createdefaultmasterkey.
...
GhostX Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
completely stable. [Tags](https://github.com/GhostX-coin/GhostX-core/tags) are created
regularly to indicate new official, stable release versions of GhostX Core.
