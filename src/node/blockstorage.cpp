...
bool BlockManager::WriteBlockUndo(const CBlockUndo& blockundo, BlockValidationState& state, CBlockIndex& block)
{
    ...
    if (block.GetUndoPos().IsNull()) {
        ...
        // @TODO(sdmg15): Check if this is really needed
...
bool ReadTransactionFromBlock(const CBlockIndex* pindex, int nIndex, CTransactionRef &txOut, const BlockManager& blockman)
{
