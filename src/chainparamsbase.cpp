...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("",  51735);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 51935);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 48332);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 31932);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 51936);
    }
    assert(false);
}
